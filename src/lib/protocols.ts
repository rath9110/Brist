...
export const PROTOCOLS: Record<DeficiencyArea, Protocol> = {
  ...
  zinc: {
    ...
    note: "Långvarig zink tömmer koppar — lägg till 1–2 mg koppar om du tar det längre än 8 veckor.",
    biomarker: "S-Zink",
  ...
  thyroid: {
    ...
    dose: "",
    duration: "",
    note: "Dina svar tyder på att sköldkörtelfunktionen bör utvärderas av en läkare. Det här är inget att oroa sig för — det handlar om att få rätt hjälp.",
    biomarker: "TSH",
